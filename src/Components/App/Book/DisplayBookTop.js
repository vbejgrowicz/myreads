  ...
  render() {
    return (
      <div className="book-top">
        ...
        <CheckShelf setLoadState={this.props.setLoadState} mode={this.props.mode} book={this.props.book} booksOnShelf={this.props.booksOnShelf} updateBooks={this.props.updateBooks} searchBooks={this.props.searchBooks} />
      </div>
    );
  }
}
